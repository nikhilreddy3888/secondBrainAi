...
class LlamaCppBindings {
  ...
  static DynamicLibrary loadBackendLibrary() {
    ...
    if (Platform.isIOS) {
      try {
        return DynamicLibrary.open('RABackendLLAMACPP.framework/RABackendLLAMACPP');
      } catch (e) {
        // Fallback to commons/executable for statically linked builds
      }
    }

    // On iOS (fallback) or macOS, everything is statically linked or merged
