...
class RunAnywhere {
  ...
  static Future<void> _runDiscovery() async {
    ...
    // Temporary Android safeguard: native discovery can crash on some builds.
    // The app can still work by updating model download status explicitly.
    if (Platform.isAndroid) {
      _hasRunDiscovery = true;
      logger.warning(
        'Skipping native discovery on Android due to known crash in discovery bridge',
      );
      return;
    }
